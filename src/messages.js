export default {
  'about.title': 'Welcome to the CollectionSpace Bonsai Demo',
  'about.contentHTML': `
    <p>
    ...
    <p>
      To log in, use the email <strong>admin@bonsai.collectionspace.org</strong>, with the
      case-sensitive password <strong>Administrator</strong>. To view in read-only mode, use the
      email <strong>reader@bonsai.collectionspace.org</strong> with the password
